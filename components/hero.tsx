        ...
        >
          ...
          <div className="mt-10">
            <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.98 }} className="inline-block">
              <Button
                size="lg"
                className="hero-add-button group relative min-h-16 overflow-hidden rounded-2xl border border-amber-300/50 bg-gradient-to-r from-amber-500 via-amber-500 to-orange-500 px-10 py-7 text-lg font-bold text-white shadow-[0_10px_30px_rgba(245,158,11,0.35)] transition-all duration-300 hover:shadow-[0_16px_40px_rgba(245,158,11,0.5)]"
              >
                <Bubbles />
                <span className="absolute inset-0 bg-white/10 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                <Plus className="hero-plus relative z-10 h-5 w-5 transition-transform duration-300 group-hover:rotate-90 group-hover:scale-125" />
